...
RUN apk add --no-cache ruby=2.5.5-r0 ruby-bigdecimal=2.5.5-r0 ruby-bundler=1.17.1-r0 ruby-io-console=2.5.5-r0 ruby-irb=2.5.5-r0 ca-certificates=20190108-r0 libressl=2.7.5-r0 sqlite=3.26.0-r3 && \
